                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="login_part_text text-center">
                            <div class="login_part_text_iner">
                                ...
                                <a href="/users/register" class="btn_3">Tạo tài khoản</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6">
                        <div class="login_part_form">
                            <div class="login_part_form_iner">
                                ...
                                <form:form class="row contact_form" action="/users/login" method="post" modelAttribute="user" novalidate="novalidate">
                                    <div class="col-md-12 form-group p_star">
                                        <form:input type="text" class="form-control" path="phone" placeholder="Số Điện Thoại của bạn"/>
                                        <form:errors path="phone" cssClass="text-danger"/>
                                    </div>
                                    <div class="col-md-12 form-group p_star">
                                        <form:input type="password" class="form-control" path="password" placeholder="Mật khẩu"/>
